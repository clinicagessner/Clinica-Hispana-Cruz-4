...
export const LANDING_COPY: Record<Locale, LandingCopy> = {
  es: {
    ...
    diff: {
      title: "¿Por qué los hispanos eligen Clínica Cruz 4?",
      subtitle:
    ...
    comparison: {
      ...
      subtitle:
        "Si está en Bellaire, Sharpstown o el suroeste de Houston, vea qué hace diferente a Clínica Cruz 4 frente a otras clínicas hispanas del área.",
      headers: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Sí. No necesita seguro médico para atenderse con nosotros. Ofrecemos precios accesibles de pago directo y le informamos el costo antes de la consulta. Aceptamos efectivo y tarjeta.",
        },
        {
        ...
        },
        {
          ...
          a: "Estamos en 10100 Beechnut St Ste 240, Houston, TX 77072, en el área de Sharpstown. Servimos a Spring Branch, Westchase, Alief, Bellaire, Meyerland, Gulfton y todo el suroeste de Houston. Estacionamiento gratuito disponible.",
        },
      ],
    },
    finalCta: {
  ...
  en: {
    ...
    diff: {
      title: "Why Hispanic patients choose Clínica Cruz 4",
      subtitle:
    ...
    comparison: {
      ...
      subtitle:
        "If you're in Bellaire, Sharpstown, or southwest Houston, see how Clínica Cruz 4 compares to other Hispanic clinics in the area.",
      headers: {
        feature: "Feature",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Yes. You don't need health insurance to be seen with us. We offer affordable self-pay rates and tell you the cost before your visit. We accept cash and cards.",
        },
        {
        ...
        },
        {
          ...
          a: "We are at 10100 Beechnut St Ste 240, Houston, TX 77072, in the Sharpstown area. We serve Spring Branch, Westchase, Alief, Bellaire, Meyerland, Gulfton, and all of southwest Houston. Free parking available.",
        },
      ],
    },
    finalCta: {
