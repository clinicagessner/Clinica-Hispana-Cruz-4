    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          {...register("telefono", {
            onChange: (e) => {
              // Solo 10 dígitos: descarta todo lo que no sea número.
      ...
      {/* Alerta general cuando se intenta enviar con errores */}
      {isSubmitted && Object.keys(errors).length > 0 && (
        <div
          role="alert"
          aria-live="assertive"
          className="flex items-center gap-2 text-destructive bg-error-light p-3 rounded-lg text-sm"
        >
