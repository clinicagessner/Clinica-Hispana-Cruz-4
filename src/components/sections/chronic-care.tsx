  ...
  return (
    <section id="chronic-care" className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/services/chronic-conditions.jpg"
          alt={locale === "en" ? "Chronic disease management at Clinica Hispana Cruz 4" : "Manejo de enfermedades crónicas en Clínica Hispana Cruz 4"}
          fill
