...
export async function sendContactEmail(
  ...
  try {
    await resend.emails.send({
      from: "Nuevo paciente desde el Website <noreply@clinicahispanacruz4.com>",
      to: [CONTACT_INFO.email],
      replyTo: email || undefined,
      subject: `Nuevo paciente desde el website: ${nombre} — ${serviceName}`,
      html: `
        <!DOCTYPE html>
        <html>
          <head>
            ...
            <title>Nuevo paciente desde el website</title>
          </head>
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #1E293B; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #8c1218 0%, #d8232a 100%); padding: 30px; border-radius: 12px 12px 0 0;">
              <h1 style="color: white; margin: 0; font-size: 24px;">Nuevo paciente desde el website</h1>
              <p style="color: rgba(255,255,255,0.8); margin: 10px 0 0 0;">Clínica Hispana Cruz 4 — recibido desde el formulario web</p>
            </div>
