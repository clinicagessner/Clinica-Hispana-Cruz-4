...
const COPY = {
  es: {
    ...
    description:
      "Clínica hispana abierta sin cita previa en Houston, todos los días de 9 AM a 9 PM. Atención en español, cerca de mí. Walk-in clinic en Beechnut St.",
  ...
  en: {
    ...
    description:
      "Hispanic walk-in clinic in Houston, open 7 days a week 9 AM - 9 PM. Spanish-speaking care near you, no appointment needed. Located on Beechnut St.",
